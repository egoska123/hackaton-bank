...
const CameraIcon: React.FC<CameraIconProps> = ({ width = 40, height = 34 }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 40 34" fill="none">
      ...
      <Ellipse cx="10.8209" cy="17.647" rx="2.5" ry="4.5" transform="rotate(28.0155 10.8209 17.647)" fill="#D9D9D9"/>
